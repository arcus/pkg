...
type Adaptor func(hdlr service.Handler) echo.HandlerFunc

// DefaultAdaptor returns an Adaptor that decodes the request into the
...
func DefaultAdaptor(hdlr service.Handler, req proto.Message) echo.HandlerFunc {
